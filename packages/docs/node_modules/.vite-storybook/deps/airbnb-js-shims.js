...
var require_es6_shim = __commonJS({
  "../../node_modules/es6-shim/es6-shim.js"(exports, module) {
    (function(root, factory) {
      ...
      if (supportsDescriptors) {
        var ES5ObjectShims = {
          setPrototypeOf: function(Object2) {
            var set;
            ...
            try {
              set = Object2.getOwnPropertyDescriptor(Object2.prototype, "__proto__").set;
              _call(set, {}, null);
            } catch (e) {
              if (Object2.prototype !== {}.__proto__) {
                return;
              }
              set = function(proto) {
...
var require_SameValueZero = __commonJS({
  "../../node_modules/es-abstract/2024/SameValueZero.js"(exports, module) {
    "use strict";
    var $isNaN = require_isNaN();
...
var require_RequireObjectCoercible2 = __commonJS({
  "../../node_modules/es-abstract/2024/RequireObjectCoercible.js"(exports, module) {
    "use strict";
    module.exports = require_RequireObjectCoercible();
  }
});
...
var require_PromiseResolve = __commonJS({
  "../../node_modules/es-abstract/2023/PromiseResolve.js"(exports, module) {
    "use strict";
    var GetIntrinsic = require_get_intrinsic();
    var callBind = require_call_bind();
    var $SyntaxError = require_syntax();
...
var require_ArrayCreate = __commonJS({
  "../../node_modules/es-abstract/2023/ArrayCreate.js"(exports, module) {
    "use strict";
    var GetIntrinsic = require_get_intrinsic();
...
var require_ArraySpeciesCreate = __commonJS({
  "../../node_modules/es-abstract/2023/ArraySpeciesCreate.js"(exports, module) {
    "use strict";
    var GetIntrinsic = require_get_intrinsic();
    var $species = GetIntrinsic("%Symbol.species%", true);
    var $TypeError = require_type();
...
var require_IsAccessorDescriptor2 = __commonJS({
  "../../node_modules/es-abstract/2023/IsAccessorDescriptor.js"(exports, module) {
    "use strict";
    var $TypeError = require_type();
    var hasOwn = require_hasown();
    var isPropertyDescriptor = require_property_descriptor();
...
var require_IsExtensible2 = __commonJS({
  "../../node_modules/es-abstract/2023/IsExtensible.js"(exports, module) {
    "use strict";
    var GetIntrinsic = require_get_intrinsic();
    var $preventExtensions = GetIntrinsic("%Object.preventExtensions%", true);
    var $isExtensible = GetIntrinsic("%Object.isExtensible%", true);
...
var require_IsGenericDescriptor2 = __commonJS({
  "../../node_modules/es-abstract/2023/IsGenericDescriptor.js"(exports, module) {
    "use strict";
    var $TypeError = require_type();
...
var require_ValidateAndApplyPropertyDescriptor2 = __commonJS({
  "../../node_modules/es-abstract/2023/ValidateAndApplyPropertyDescriptor.js"(exports, module) {
    "use strict";
    var $TypeError = require_type();
    var DefineOwnProperty = require_DefineOwnProperty();
    var isFullyPopulatedPropertyDescriptor = require_isFullyPopulatedPropertyDescriptor();
...
var require_OrdinaryDefineOwnProperty2 = __commonJS({
  "../../node_modules/es-abstract/2023/OrdinaryDefineOwnProperty.js"(exports, module) {
    "use strict";
    var $gOPD = require_gopd();
    var $SyntaxError = require_syntax();
    var $TypeError = require_type();
...
var require_CreateDataProperty2 = __commonJS({
  "../../node_modules/es-abstract/2023/CreateDataProperty.js"(exports, module) {
    "use strict";
    var $TypeError = require_type();
    var IsPropertyKey = require_IsPropertyKey();
...
var require_CreateDataPropertyOrThrow = __commonJS({
  "../../node_modules/es-abstract/2023/CreateDataPropertyOrThrow.js"(exports, module) {
    "use strict";
    var $TypeError = require_type();
...
var require_HasProperty2 = __commonJS({
  "../../node_modules/es-abstract/2023/HasProperty.js"(exports, module) {
    "use strict";
    var $TypeError = require_type();
    var IsPropertyKey = require_IsPropertyKey();
    var Type = require_Type2();
...
var require_LengthOfArrayLike2 = __commonJS({
  "../../node_modules/es-abstract/2023/LengthOfArrayLike.js"(exports, module) {
    "use strict";
    var $TypeError = require_type();
    var Get = require_Get2();
...
var require_FlattenIntoArray = __commonJS({
  "../../node_modules/es-abstract/2023/FlattenIntoArray.js"(exports, module) {
    "use strict";
    var $TypeError = require_type();
    var MAX_SAFE_INTEGER = require_maxSafeInteger();
...
var require_ToObject2 = __commonJS({
  "../../node_modules/es-abstract/2023/ToObject.js"(exports, module) {
    "use strict";
...
var require_IteratorValue = __commonJS({
  "../../node_modules/es-abstract/2024/IteratorValue.js"(exports, module) {
    "use strict";
    var $TypeError = require_type();
    var Get = require_Get();
    var Type = require_Type3();
...
var require_PromiseResolve2 = __commonJS({
  "../../node_modules/es-abstract/2024/PromiseResolve.js"(exports, module) {
    "use strict";
    var GetIntrinsic = require_get_intrinsic();
    var callBind = require_call_bind();
    var $SyntaxError = require_syntax();
...
var require_AsyncFromSyncIteratorContinuation = __commonJS({
  "../../node_modules/es-abstract/2024/AsyncFromSyncIteratorContinuation.js"(exports, module) {
    "use strict";
    var GetIntrinsic = require_get_intrinsic();
    var $SyntaxError = require_syntax();
    var $TypeError = require_type();
    ...
    var PromiseResolve = require_PromiseResolve2();
    var Type = require_Type3();
...
var require_CreateAsyncFromSyncIterator = __commonJS({
  "../../node_modules/es-abstract/2024/CreateAsyncFromSyncIterator.js"(exports, module) {
    "use strict";
    var GetIntrinsic = require_get_intrinsic();
    var $SyntaxError = require_syntax();
    var $TypeError = require_type();
...
var require_GetIteratorFromMethod = __commonJS({
  "../../node_modules/es-abstract/2024/GetIteratorFromMethod.js"(exports, module) {
    "use strict";
    var $TypeError = require_type();
    var Call = require_Call();
    var Get = require_Get();
...
var require_GetIterator = __commonJS({
  "../../node_modules/es-abstract/2024/GetIterator.js"(exports, module) {
    "use strict";
    var GetIntrinsic = require_get_intrinsic();
    var $TypeError = require_type();
...
var require_IteratorStep = __commonJS({
  "../../node_modules/es-abstract/2024/IteratorStep.js"(exports, module) {
    "use strict";
    var $TypeError = require_type();
    var IteratorComplete = require_IteratorComplete();
    var IteratorNext = require_IteratorNext();
...
var require_AddEntriesFromIterable = __commonJS({
  "../../node_modules/es-abstract/2024/AddEntriesFromIterable.js"(exports, module) {
    "use strict";
    var inspect = require_object_inspect();
    var $TypeError = require_type();
    var Call = require_Call();
...
var require_ToPropertyKey = __commonJS({
  "../../node_modules/es-abstract/2024/ToPropertyKey.js"(exports, module) {
    "use strict";
    var GetIntrinsic = require_get_intrinsic();
    var $String = GetIntrinsic("%String%");
    var ToPrimitive = require_ToPrimitive();
...
var require_IsRegExp = __commonJS({
  "../../node_modules/es-abstract/2024/IsRegExp.js"(exports, module) {
    "use strict";
    var GetIntrinsic = require_get_intrinsic();
...
var require_DefineMethodProperty = __commonJS({
  "../../node_modules/es-abstract/2024/DefineMethodProperty.js"(exports, module) {
    "use strict";
    var $TypeError = require_type();
...
var require_RegExpExec = __commonJS({
  "../../node_modules/es-abstract/2024/RegExpExec.js"(exports, module) {
    "use strict";
    var $TypeError = require_type();
...
var require_CreateRegExpStringIterator = __commonJS({
  "../../node_modules/es-abstract/2024/CreateRegExpStringIterator.js"(exports, module) {
    "use strict";
    var GetIntrinsic = require_get_intrinsic();
    var hasSymbols = require_has_symbols()();
    var $TypeError = require_type();
...
var require_ArraySpeciesCreate2 = __commonJS({
...
var require_implementation17 = __commonJS({
  "../../node_modules/array.prototype.map/implementation.js"(exports, module) {
    "use strict";
    var ArraySpeciesCreate = require_ArraySpeciesCreate2();
    var Call = require_Call();
    var CreateDataPropertyOrThrow = require_CreateDataPropertyOrThrow2();
    var Get = require_Get();
    var HasProperty = require_HasProperty();
...
var require_shim19 = __commonJS({
  "../../node_modules/promise.allsettled/shim.js"(exports, module) {
    "use strict";
    var requirePromise = require_requirePromise2();
    var getPolyfill = require_polyfill19();
    var define2 = require_define_properties();
